...
| Parte | Conteúdo |
|---|---|
| 0 | Resumo em doze linhas e seis trilhas de leitura |
| 1 | Diagnóstico — os três pilares, autoestima contingente, ciclo cognitivo, viés de negatividade, teoria do sociômetro, as seis dimensões de bem-estar, escassez e banda cognitiva |
...
| 5 | Como construir — os sete mecanismos, declaração de identidade, comunidade, perdão, quando buscar ajuda, e o autodiagnóstico interativo |
...
| 9 | Nove fichas imprimíveis |
| 10 | Biblioteca comentada — tese, ideias práticas, capítulo de entrada e índice por dor |

Vinte e três diagramas em SVG inline, todos legíveis em tema claro e escuro.

## Autodiagnóstico

A Parte 5.6 traz quatro instrumentos respondidos na própria página, com cálculo, faixas interpretativas e histórico com gráfico de evolução:
